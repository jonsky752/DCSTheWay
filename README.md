...
## How to install?
1. Download the latest zip file from the Releases section [found here]([https://github.com/aronCiucu/DCSTheWay/releases](https://github.com/jonsky752/DCSTheWay/releases)), and extract it. 
